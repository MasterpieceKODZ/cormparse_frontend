...
const ProjectTableHeadBtn = ({ label }: { label: string }) => {
	return (
		<button
			...
			className=" tw-w-max tw-h-max tw-rounded-md tw-py-1 tw-px-2 tw-my-1 tw-flex tw-justify-center tw-items-end tw-bg-transparent hover:tw-bg-gray-200 dark:hover:tw-bg-gray-700 project_tb_hd"
