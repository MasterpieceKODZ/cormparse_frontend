	...
	return (
		<div className=" tw-w-full tw-h-max tw-grid tw-grid-cols-[auto_1fr] tw-my-8">
			...
			<div className=" tw-w-full tw-h-max">
				...
				<div
					id={`updt_bdy_${position}`}
					className=" tw-w-full tw-h-max tw-mt-5 tw-px-4 tw-text-gray-700 dark:tw-text-gray-300 iss_updt"></div>
				<div>
					{showUpdate ? (
						((bdy: string): string => {
							document.getElementById(`updt_bdy_${position}`)!.innerHTML = bdy;
							return "";
						})(body)
					) : (
						<></>
