...
import AddPersonLayout from "@/components/workspace/project-details/people/add.person.layout";
import BtnAddPersonToProject from "@/components/workspace/project-details/people/btn.add.person";
